...
@section('content')
    ...
    <div class="py-8 bg-white">
      ...
      <div>
            <a href="{{ route('players.create') }}"><button class="px-6 py-2 mx-auto block rounded-md text-lg font-semibold text-lime-100 bg-lime-600">
            Crear Jugador
          </button></a>
      </div>
              ...
              <table class="min-w-full leading-normal table-fixed">
                <thead>
                  <tr>
                    ...
                    <th
                      class="w-1/4 px-5 py-3 border-b-2 border-gray-200 bg-indigo-50 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                      Nom Jugador
                    </th>
                    <th
                    class="w-1/4 px-5 py-3 border-b-2 border-gray-200 bg-indigo-50 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="px-7 py-5 border-b border-gray-200 bg-white text-sm ">
                      <button class="px-6 py-2 mx-auto block rounded-md text-lg font-semibold">
                        <a href={{ route('players.destroy', $player) }}>
