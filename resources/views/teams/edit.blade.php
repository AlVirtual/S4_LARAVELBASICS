                ...
                <form action="{{ route('teams.update', $team) }}" method="POST">
                    ...
                    <div class="px-4 max-w-3xl mx-auto space-y-4 bg-lime-50 py-2">
                        <div class="w-1/8">
                            ...
                            <br>
                            <input type="text" name="name" value="{{$team->name}}" class="mt-1 block w-full py-2 px-3 border-b border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-lime-500 focus:border-lime-500 sm:text-sm">   
                        </div>
                        <div class="w-1/8">    
                            <label for="">
